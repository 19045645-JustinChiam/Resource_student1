...
//>>>>>>> branch 'master' of https://github.com/19045645-JustinChiam/Resource_student1.git
	...
	public void doLoanChromebookTest() {
		...
		ResourceCentre.doLoanChromebook(chromebookList, "CB001", "12-12-2020");
		ResourceCentre.loanChromebook(chromebookList);
		assertTrue(
				"User enters an asset tag, if it is valid, the system will check if it is available " +
		"or if it has been loaned out, else the system would display that the user has entered an invalid asset tag ",
				true);
		...
		ResourceCentre.loanChromebook(chromebookList);
		assertTrue(
				"User attempts to loan a chromebook that was already unavailable " +
		" because it was loaned out", false);
		...
		ResourceCentre.loanChromebook(chromebookList);
		assertTrue(
				"User enters an invalid asset which included characters that are not part of a valid asset tag, " +
		" the system would display that the user has entered an invalid asset tag", false);
	}
	...
	public void doReturnChromebookTest() {
		...
		// Boundary Condition
		// When user enters the Asset tagnumber CB0011 to return the chromebook which
		// was not loaned made
